      ...
      <div name="Contact" className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-16">
        ...
        <div className=" flex flex-col items-center justify-center mt-5">
          <form
            ...
            // action="https://getform.io/f/bnleeklb"
            // method="POST"
            className="bg-green-600 text-white w-96 px-8 py-6 rounded-xl"
          >
            ...
            <button
              type="submit"
              className="bg-red-400 text-white rounded-xl px-3 py-2 hover:bg-slate-700 duration-300"
            >
              Send
            </button>
          </form>
